...
import org.aurora.android.navigation.NavigationState
import org.aurora.android.navigation.model.StoplightState
...
@Composable
fun StoplightCard(stoplight: org.aurora.android.navigation.model.Stoplight) {
...
fun TripCompleteModal(
    route: org.aurora.android.navigation.model.NavigationRoute,
    hazardsAvoided: Int,
    timeSaved: Int,
    onDismiss: () -> Unit
) {
    androidx.compose.ui.window.Dialog(onDismissRequest = onDismiss) {
        Card(
            ...
            Column(
                ...
                // Achievement badge
                if (route.type == org.aurora.android.navigation.model.RouteType.SMART) {
                    Surface(
